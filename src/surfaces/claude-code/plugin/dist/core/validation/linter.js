...
class MdocsLinter {
    ...
    lintInitiative(content, filePath) {
        ...
        const front = (0, types_1.parseFrontmatter)(content);
        const status = (0, initiative_store_1.normalizeInitiativeStatus)(front.status);
        const expectedDuration = (0, types_1.readExpectedDurationRaw)(front);
        ...
        if ((0, types_1.isCompleted)(status)) {
...
exports.MdocsLinter = MdocsLinter;
