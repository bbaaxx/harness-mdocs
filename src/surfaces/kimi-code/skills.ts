...
/**
 * Asset resolution for the Kimi Code surface.
 *
 * Assets (SKILL.md files, templates) ship at
 *   <pkg>/src/surfaces/kimi-code/assets/
 * and are NOT compiled. From the compiled module at
 *   <pkg>/dist/surfaces/kimi-code/skills.js
 * the assets dir is three levels up plus the src path. Mirrors the Claude
 * Code / pi surface skills.ts.
 */
export function assetsDir(): string {
  return path.resolve(__dirname, '../../../src/surfaces/kimi-code/assets');
}
...
/** Read a template file by name (e.g. 'kimi-mcp.json'). Returns null if missing. */
