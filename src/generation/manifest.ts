...
const outputs = [
  ...
  output('.kimi-code/agents/mdocs-orchestrator.md', 'kimi.agent.orchestrator'),
  output('.kimi-code/skills/mdocs-initiative/SKILL.md', 'kimi.skill.initiative'),
  output('.kimi-code/skills/mdocs-orchestrator/SKILL.md', 'kimi.skill.orchestrator'),
  output('.kimi-code/skills/mdocs-workflow/SKILL.md', 'kimi.skill.workflow'),
  ...
  output('src/surfaces/kimi-code/assets/agents/mdocs-orchestrator.md', 'kimi.agent.orchestrator'),
  output('src/surfaces/kimi-code/assets/skills/mdocs-initiative/SKILL.md', 'kimi.skill.initiative'),
  output('src/surfaces/kimi-code/assets/skills/mdocs-orchestrator/SKILL.md', 'kimi.skill.orchestrator'),
  output('src/surfaces/kimi-code/assets/skills/mdocs-workflow/SKILL.md', 'kimi.skill.workflow'),
  output('src/surfaces/kimi-code/assets/templates/kimi-agents-md-snippet.md', 'kimi.template.memory'),
  output('src/surfaces/kimi-code/assets/templates/kimi-mcp.json', 'kimi.template.mcp'),
  output('src/surfaces/kimi-code/plugin/agents/mdocs-orchestrator.md', 'kimi.agent.orchestrator'),
  output('src/surfaces/kimi-code/plugin/skills/mdocs-initiative/SKILL.md', 'kimi.skill.initiative'),
  output('src/surfaces/kimi-code/plugin/skills/mdocs-orchestrator/SKILL.md', 'kimi.skill.orchestrator'),
  output('src/surfaces/kimi-code/plugin/skills/mdocs-workflow/SKILL.md', 'kimi.skill.workflow'),
...
export const AGENT_ASSET_GENERATION: GenerationDefinition = {
  ...
  managedRoots: [
    ...
    'src/surfaces/kimi-code/assets/agents',
    'src/surfaces/kimi-code/assets/skills',
    'src/surfaces/kimi-code/assets/templates',
    'src/surfaces/kimi-code/plugin/agents',
    'src/surfaces/kimi-code/plugin/skills',
  ...
  sources: [
    ...
    source('kimi.agent.orchestrator', 'kimi-agent-orchestrator.md'),
    source('kimi.skill.initiative', 'kimi-skill-initiative.md'),
    source('kimi.skill.orchestrator', 'kimi-skill-orchestrator.md'),
    source('kimi.skill.workflow', 'kimi-skill-workflow.md'),
    source('kimi.template.mcp', 'kimi-template-mcp.json'),
    source('kimi.template.memory', 'kimi-template-memory.md'),
