...
- **cc3 wiki canonical id/ref tolerance + consumer overview/log emitter format** (done) — cc3-wiki-id-and-emitters--2026-06-24.md — 2026-06-24 — [core, wiki, compat, ingest, emitters]
...
- **Dogfood local OpenCode plugin build** (done) — dogfood-local-opencode-plugin--2026-07-03.md — 2026-07-03 — [opencode, dogfood, plugin, config]
- **Extensible Mdocs Orchestrator Route and Run capabilities** (done) — extensible-harness-agents--2026-08-21.md — 2026-08-21 — [agents, orchestrator, route, run, harness, opencode, claude-code, codex, pi, capabilities, permissions, extensibility]
...
- **Kimi Code surface for harness-mdocs** (done) — kimi-code-surface-for-harness-mdocs--2026-09-16.md — 2026-09-16 — [surface, kimi-code, hooks, plugin, packaging, harness]
...
- **Local test of unreleased build before v2.0.0** (done) — local-test-unreleased--2026-09-15.md — 2026-09-15 — [testing, release-prep]
- **P0: Lossless metadata-only wiki mutations** (done) — p0-lossless-metadata-only-wiki-mutations--2026-08-10.md — 2026-08-10 — [bugfix, metadata-only, github-issue-8]
...
- **Verify docs after v2 + kimi-code surface** (done) — verify-docs-after-v2-kimi-code-surface--2026-09-16.md — 2026-09-16 — []
