...
- **Fix pre-release dogfood findings (gitSha, CLI create activation, CLI output contract)** (active) — fix-pre-release-dogfood-findings-gitsha-cli-create-activation-cli-output-contract--2026-09-15.md — 2026-09-15 — [pre-release, dogfood, cli, bug]
