...
- [x] Commit release metadata on staging.
- [x] Open/merge release PR to main, then tag `v0.6.0` and push to trigger publish workflow.
...
- [2026-07-03T19:12:27.856Z] Marked done via mdocs command
